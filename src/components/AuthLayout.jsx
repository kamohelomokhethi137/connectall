    ...
    <div className="min-h-screen bg-paper relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-28 pb-16">
        <Link to="/" className="flex items-center gap-2 mb-8">
          <Mark className="w-8 h-8 text-navy" />
          <span className="font-display font-semibold text-xl text-ink">
            ConnectAll
          </span>
        </Link>

        <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_1px_2px_rgba(16,25,43,0.04),0_16px_40px_rgba(16,25,43,0.08)] border border-ink/5 px-8 py-10 sm:px-10">
